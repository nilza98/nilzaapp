    ...
    <div id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Mulher elegante com cabelo grisalho"
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-10">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold text-white mb-8 animate-fade-in-up leading-tight drop-shadow-2xl">
          Nilza Alves <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-300 to-brand-accent">Beauty Home Care</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <a
            href="#stylist"
            className="w-full sm:w-auto px-10 py-4 bg-brand-accent hover:bg-pink-500 text-white text-lg font-bold rounded-full transition-all shadow-lg shadow-pink-900/60 hover:scale-105 hover:shadow-pink-500/40"
          >
            Simular Novo Visual
          </a>
          <a
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce text-brand-accent opacity-80 hover:opacity-100 transition-opacity cursor-pointer">
        <a href="#about"><ArrowDown className="h-10 w-10" /></a>
      </div>
    </div>
  );
};